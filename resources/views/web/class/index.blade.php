                    ...
                    <div class="overflow-hidden shadow">
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                               ...
                               <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        ...
                                        <div x-data="confirm()" class="inline-block">
                                            <button @click="openDeleteModal('{{route('admin.schools.destroy',$class->id)}}')" type="button"  class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                               ...
                               @empty
                                   <span class="dark:text-white flex justify-center">No more school data!</span>
                               @endforelse
                            </tbody>
                        </table>
                        <div class="py-5">
