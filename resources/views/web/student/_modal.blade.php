    ...
    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                <h3 class="text-xl font-semibold dark:text-white" x-text="editMode ? 'Edit Teacher' : 'Add new Student'"></h3>
                  ...
                  <div class="grid grid-cols-6 gap-6 mb-3">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select id="class_id" x-model="form.class_id"
                            ...
                            <template x-for="(clas,index) in classes" :key="index">
                                <option :value="clas.id" x-text="clas.name"
                                    :selected="editMode && clas.id == form.class_id">
                                </option>
                            </template>
                        </select>
                        <template x-if="errors.class_id">
                            <p class="text-red-500" x-text="errors.class_id"></p>
                        </template>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
