    ...
    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                <h3 class="text-xl font-semibold dark:text-white" >Student Excel Import</h3>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <span >
                                    <div class="flex items-center space-x-2 bg-gray-100 dark:bg-gray-800 p-2 rounded-lg">
                                        <span class="font-medium text-gray-800 dark:text-white" >Roll name</span>
                                        <span class="text-gray-500">=> </span>
                                        <span class="text-primary-600 font-semibold" >Student</span>
                                    </div>
                                </template>
                            </div>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            <a class="flex justify-end text-red-500 font-bold" href="{{route('student-demo')}}">Demo file</a>
