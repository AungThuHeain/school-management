<div x-show="importModalOpen" x-cloak class="fixed left-0 right-0 z-50 flex items-center justify-center  overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full bg-gray-700 bg-opacity-60" >
    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                ...
                <button @click="importModalOpen = false" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white" >
            ...
            <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <input @change="handleFileUpload(event)" type="file" name="file" id="file"
                                   class="block w-full p-2.5 text-gray-900 bg-gray-50 rounded-lg shadow-sm
                ...
                <div class=" justify-between flex p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                    <button type="button" @click="importModalOpen = false" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Cancle</button>
